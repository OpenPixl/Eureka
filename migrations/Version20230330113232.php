 ...
 */
final class Version20230330113232 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE registration ADD CONSTRAINT FK_62A8A7A7591CC992 FOREIGN KEY (course_id) REFERENCES bookroom (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
